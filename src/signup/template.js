    ...
    <div class="singup-box">
      ...
      <form class="singup-form">
        ...
        <div class="section">
          ...
          <a class="btn btn-fb hide-on-med-and-up">${translate.message('signup.text')}   <i class="fa fa-facebook-official"></i></a>
        </div>
        ...
        <button class="btn waves-effect waves-light btn-singup" type="submit">${translate.message('signup.call-to-action')}</button>
      </form>
    </div>
  </div>
    <div class="row">
